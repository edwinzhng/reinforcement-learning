...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--frame-skip", type=str, help="Number of frame skips", required=False, default=1)
    parser.add_argument("-r", "--render", type=bool, help="Render game on screen", required=False, default=False)
    args = parser.parse_args()

    # Build environment
    env = Environment(args.env_name, args.preprocess, args.render, args.frame_skip)
